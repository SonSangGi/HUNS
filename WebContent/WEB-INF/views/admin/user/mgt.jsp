...
<body>
	...
	<div id="content-wrapper" style="max-width: 1400px;"
		...
		<div class="container-fluid">
			...
			<div class="card">
				<div class="card-header">탈퇴/휴면 회원 조회</div>
				<div class="card-body">
					<hr>
					<div class="alert alert-dark" style="margin-bottom: 0px">
						<button class="btn btn-sm btn-primary" id="delUser" onclick="delUser();">
							<small>탈퇴해제</small>
						</button>
					</div>
					<div class="table-responsive">
						<table class="table table-bordered table-sm" width="100%"
							cellspacing="0" style="font-size: 14px" id="dataTable">
							<!-- id에 js에서 설정한 값-->
							<thead>
								<tr>
		...
		function delUser(){
			...
			$("input:checkbox[name=userCheck]").each(function(){
			 ...
			 $.ajax({
				url: "delUser.do",
				type: "post",
				data: {"userNos":value, "result":"Y"},
				success:function(result){
					if(result.result=="OK"){
						alert("회원탈퇴가 해제되었습니다.");
						window.location.reload();
					} else{
						alert("탈퇴해제중 오류가 발생하였습니다.")
					}
				}
			})	 	
		}
